# League signup process s13
For the first time, in season 13 the VESA league will be utilizing a discord bot for signups. No longer will users need to log in to google and submit a form.
This will also help us expedite our sorting process as we won't have to worry about any discord username misspellings or other discrepancies while organizing.
It should also reduce the amount of time we spend assigning roles during placements.

We understand this is a new process for our users and are here to help you complete your signup correctly.
Please provide accurate information on your skill level, comp experience and vesa experience so we can sort and prioritize you correctly for placement matches. Not only does it hurt the whole lobby (57 other real human beings!) when inaccurate information is provided, it also hurts your ability to place into an appropriate division 

**Please read the following how to document so you don't spend unneeded time making mistakes during your signup!**

If you're here because you didn't read and you're having issues, please read the steps and then the "something wrong" section to help you get signed up!

## How to use the /league-signup command
...
* Fill out all the required fields
  ...
  * player 3 
    * start typing the name of player 3 and select the correct user from the dropdown
  * comp experience
  ...
  * player1-overstat-link
    * Paste the overstat url of this player or write "None". If this player has already used the /link-overstat command in the scrim server you can also write "None" and it should autofill
  * player1-platform
    * Select from the dropdown the platform this player plays on
  * player2-rank
    * Select from the dropdown the ranked tier this player achieved in the latest ranked split or most recent season with decent amount of games played
  * player2-s12-vesa-division
    * Select from the dropdown the s12 vesa division this player played in, select "None" if you did not play or all you did was sub and you were not on a roster
  * player2-overstat-link
    * Paste the overstat url of this player or write "None". If this player has already used the /link-overstat command in the scrim server you can also write "None" and it should autofill
  * player2-platform
    * Select from the dropdown the platform this player plays on
  * player3-rank
    * Select from the dropdown the ranked tier this player achieved in the latest ranked split or most recent season with decent amount of games played
  * player3-s12-vesa-division
    * Select from the dropdown the s12 vesa division this player played in, select "None" if you did not play or all you did was sub and you were not on a roster
  * player3-overstat-link 
    * Paste the overstat url of this player or write "None". If this player has already used the /link-overstat command in the scrim server you can also write "None" and it should autofill
  * player3-platform    
    * Select from the dropdown the platform this player plays on
